...
function o(r,t,...e){if("function"==typeof r)return Reflect.apply(r,t,e);if("object"==typeof r){let n=Reflect.get(r,t,e);if(void 0===n)return;return o(n,r,...e)}return null}function e(r,t,o){let e=0,n=()=>{++e>=r.length&&o();};for(let o of r)t(o,n);}class n{static Register(r){r.info&&(this.info=r.info),r.warn&&(this.warn=r.warn),r.error&&(this.error=r.error);}static Log(r,...t){n.doLogger(this.info,r,...t);}static Warn(r,...t){n.doLogger(this.warn,r,...t);}static Error(r,...t){n.doLogger(this.error,r,...t);}static doLogger(t,o,...e){let n=r__default['default']().format("YYYY-MM-DD HH:mm:ss.SSS")+": ";"string"==typeof o?t(n+o,...e):t(n,o);}}n.info=console.log,n.warn=console.warn,n.error=console.error;const c=Symbol(),i=r=>new Proxy(r,{construct:(r,t,o)=>r.prototype!==o.prototype?Reflect.construct(r,t,o):(r[c]||(r[c]=Reflect.construct(r,t,o)),r[c])});function f(r){return null!=r}
...
class BaseComponent extends cc.Component {
    Get(path, classConstructor) {
        ...
        var _node = cc.find(path, this.node);
        if (_node === null)
            return null;
...
function mapString2CCAssetType(classname) {
    let _ccclass = cc.Asset;
    switch (classname) {
        case 'Prefab':
            _ccclass = cc.Prefab;
            break;
        case 'SpriteFrame':
            _ccclass = cc.SpriteFrame;
            break;
        case 'Texture2D':
            _ccclass = cc.Texture2D;
            break;
        case 'Material':
            _ccclass = cc.Material;
            break;
    }
    return _ccclass;
}
...
let ResConfig = class ResConfig {
    ...
    Load(asset) {
        return new Promise((resolve, reject) => {
            ...
            cc.resources.load("configs/res", cc.JsonAsset, (_error, _data) => {
                if (_error !== undefined) {
                    reject(_error);
                    return;
                }
...
exports.ResourceManager = ResourceManager_1 = class ResourceManager {
    constructor() {
        //config:ResConfig = {};
        // 按照 bundle 名称分组资源
    ...
    loadScene(sceneName, progress, launched) {
        ...
        if (!f(_sceneInfo.bundle)) {
            cc.director.preloadScene(sceneName, (completedCount, totalCount, item) => {
                ...
                cc.director.loadScene(sceneName, launched);
            });
            return;
        }
    ...
    pullBundle(bundleName) {
        return new Promise((resolve, reject) => {
            if (this.bundles.has(bundleName)) {
                ...
                this.bundles.set("resources", cc.resources);
                resolve(cc.resources);
                return;
            }
            cc.assetManager.loadBundle(bundleName, (_error, _bundle) => {
                if (f(_error))
...
exports.ResourceManager = ResourceManager_1 = __decorate([
    i
...
(function (UIType) {
    ...
    UIType["Popup"] = "Popup";
})(exports.UIType || (exports.UIType = {}));
class UIBase extends BaseComponent {
    constructor() {
        super(...arguments);
        this.__uiType = exports.UIType.Normal;
...
let UIConfig = class UIConfig {
    ...
    Load(asset) {
        return new Promise((resolve, reject) => {
            ...
            cc.resources.load("configs/uis", cc.JsonAsset, (_error, _data) => {
                if (_error !== undefined) {
                    reject(_error);
                    return;
                }
...
exports.UIManager = UIManager_1 = class UIManager extends cc.Component {
    constructor() {
        super();
    ...
    initialize(asset) {
        return new Promise((resolve, reject) => {
            this.StandaloneUIRoot = cc.find("StandaloneUI", this.node);
            this.NormalUIRoot = cc.find("NormalUI", this.node);
            this.PopupUIRoot = cc.find("PopupUI", this.node);
            this.config.Load(asset).then(_config => {
                resolve(undefined);
            });
        });
    ...
    hideUI(UIKey, callback) {
        ...
        switch (_uiType) {
            case exports.UIType.Standalone:
                this.hideStandaloneUI(UIKey);
                break;
            case exports.UIType.Normal:
                this.hideNormalUI(UIKey);
                break;
            case exports.UIType.Popup:
    ...
    spawnUI(uiInfo) {
        ...
        let _uiType = (_c = uiInfo.type) !== null && _c !== void 0 ? _c : exports.UIType.Normal;
        if (!MetaData.IsUIScriptRegistered(_uiScript)) {
            console.warn("No ui script registered for ui %s", _uiScript);
        }
        let _uiPrefab = exports.ResourceManager.Instance.Get(_assetName, this.sceneName);
        ...
        _uiPrefab = _uiPrefab;
        const _uiNode = cc.instantiate(_uiPrefab);
...
exports.UIManager = UIManager_1 = __decorate([
    ccclass,
    executionOrder(-1001)
], exports.UIManager);
(function () {
...
var SceneManager_1;
exports.SceneManager = SceneManager_1 = class SceneManager {
    constructor() {
    ...
    setSceneName(val) {
        ...
        Reflect.set(exports.ResourceManager.Instance, "sceneName", this.sceneName);
    }
    initialize() {
    ...
    Load(sceneName, progress, completed) {
        ...
        exports.ResourceManager.Instance.loadScene(sceneName, (completedcount, totalCount, item) => {
            if (f(progress))
                progress(completedcount / totalCount);
        }, (error, sceneAsset) => {
            // 
            n.Log("场景加载完成..", exports.UIManager.Instance);
            // 加载场景自定义资源
            exports.ResourceManager.Instance.LoadSceneRes([sceneName]).then(() => {
                o(exports.UIManager.Instance, "onEnterScene", sceneName);
                // 场景切换完成
...
exports.SceneManager = SceneManager_1 = __decorate([
    i
], exports.SceneManager);

class Managements {
}
Managements.UI = exports.UIManager.Instance;
Managements.Resource = new exports.ResourceManager();
Managements.Scene = new exports.SceneManager();

const { ccclass: ccclass$1, property: property$1, executionOrder: executionOrder$1 } = cc._decorator;
exports.CCHperEntry = class CCHperEntry extends BaseComponent {
    constructor() {
        super(...arguments);
        this.resConfig = null;
        this.uiConfig = null;
    ...
    initialize() {
        var _a;
        let _uiManager = (_a = this.Get("UIRoot")) === null || _a === void 0 ? void 0 : _a.addComponent(exports.UIManager);
...
], exports.CCHperEntry.prototype, "resConfig", void 0);
__decorate([
    property$1({
        type: cc.JsonAsset,
        tooltip: "UI配置文件, 默认加载 resources/configs/uis.json"
    })
], exports.CCHperEntry.prototype, "uiConfig", void 0);
exports.CCHperEntry = __decorate([
...
class Platform {
    static get IsBrowser() {
        var _a;
        return (_a = cc.sys['isBrowser']) !== null && _a !== void 0 ? _a : false;
    }
}

exports.BaseComponent = BaseComponent;
exports.ISceneScript = ISceneScript;
exports.Managements = Managements;
exports.MetaData = MetaData;
exports.PersistSceneName = PersistSceneName;
exports.Platform = Platform;
exports.StartSceneName = StartSceneName;
exports.UIBase = UIBase;
exports.mapString2CCAssetType = mapString2CCAssetType;
exports.scene_script = scene_script;
exports.ui_script = ui_script;
